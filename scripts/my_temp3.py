...
CTRV_P = np.diag(
    [0.5**2, 0.5**2, 5.**2, (np.pi)**2, (np.pi / 12)**2])
CTRV_R = np.diag([0.5**2, 0.5**2])
CTRV_Q = np.diag(
    [(0.5 * 0.5 * dt**2)**2, (0.5 * 0.5 * dt**2)**2, (0.5 * dt)**2, (np.pi / 12 * dt)**2, (np.pi / 12 * dt)**2])
CTRV_Q_aug = np.diag([0.5**2, (np.pi / 12)**2])
